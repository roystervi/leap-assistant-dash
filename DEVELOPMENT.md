...
```bash
git remote add encore encore://home-assistant-dashboard-c2pi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/home-assistant-dashboard-c2pi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/home-assistant-dashboard-c2pi/settings/integrations/github)
